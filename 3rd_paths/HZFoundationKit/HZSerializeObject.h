...
#ifndef HZSerializeObject_h
#define HZSerializeObject_h
 ...
 *  WDBMediaSerializeKit在运行时对类以及所有层级父类的变量进行遍历，避免遗漏。属性越多，优势越明显。
 *
 * Usage:
 *
 * Person.h:
 * ========================================
 *    #import "WDBMediaSerializeKit.h"
 *
 ...
 *  HZ_SERIALIZE_DESCRIPTION();//(NOT NECESSARY)
 *
 *    @end
 * ========================================
 *
 ...
 *      HZ_SERIALIZE_ARCHIVE(person, @"Person", [self filePath]);
 *
 *      //unarchive NSData to object
 *      Person *thePerson = nil;
 *      HZ_SERIALIZE_UNARCHIVE(thePerson, @"Person", [self filePath]);
 */

#define HZ_SERIALIZE_CODER_DECODER()     \
\
...
#define HZ_SERIALIZE_COPY_WITH_ZONE()  \
\
...
#define HZ_SERIALIZE_DESCRIPTION() \
\
...
/* 封装归档keyedArchiver操作 */
#define HZ_SERIALIZE_ARCHIVE(__objToBeArchived__, __key__, __filePath__)    \
\
...
#define HZ_SERIALIZE_UNARCHIVE(__objToStoreData__, __key__, __filePath__)   \
